...
key_vault_name = "pcms-dm-non-prod-kv"
...
project_name="pcms-dm-non-prod" #$pcms-custxx-non-prod or pcms-custxx-prod - replace custxx with your customer

customer_name="david" #used as a prefix to vms etc
